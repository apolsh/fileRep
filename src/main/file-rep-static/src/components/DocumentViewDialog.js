...
export default function DocumentViewDialog({isOpen}) {
            ...
            <Dialog open={isOpen} onClose={console.log} aria-labelledby="form-dialog-title">
                ...
                <DialogContent>
                    <TabPanel value={tabIndex} index={0}>
                        <TextField className={classes.dialogElements} required id="standard-required" label="Наименование" defaultValue="Спецификация 123" fullWidth/><br/>
                        <TextField
